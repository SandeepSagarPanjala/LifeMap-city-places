...
64. `si` — Slovenia (**complete**)
65. `cy` — Cyprus (**complete**)
66. `mt` — Malta (**complete**)
67. `om` — Oman (**complete**)
...
75. `mk` — North Macedonia (**complete**)
76. `lt` — Lithuania (**complete**)
77. `lv` — Latvia (**complete**)
78. `ee` — Estonia (**complete**)
79. `am` — Armenia (**complete**)
80. `az` — Azerbaijan (**complete**)
81. `lu` — Luxembourg (**complete**)
82. `bh` — Bahrain (**complete**)
83. `kw` — Kuwait (**complete**)
84. `xk` — Kosovo (**complete**)
85. `ad` — Andorra (**complete**)
86. `uz` — Uzbekistan (**complete**)
87. `la` — Laos (**complete**)
88. `tz` — Tanzania (**complete**)
89. `na` — Namibia (**complete**)
90. `et` — Ethiopia (**complete**)
91. `bw` — Botswana (**complete**)
92. `rw` — Rwanda (**complete**)
93. `gh` — Ghana (**complete**)
94. `kz` — Kazakhstan (**complete**)
95. `mn` — Mongolia (**complete**)
96. `ug` — Uganda (**complete**)
97. `sn` — Senegal (**complete**)
98. `ci` — Ivory Coast (**complete**)
99. `cm` — Cameroon (**complete**)
100. `mg` — Madagascar (**complete**)
101. `zm` — Zambia (**complete**)
102. `mu` — Mauritius (**complete**)
...
154. `sb` — Solomon Islands (**complete**)
